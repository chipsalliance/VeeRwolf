//--------------------------------------------------------------------------------
// Auto-generated by Migen (562c046) & LiteX (9d4b7cd5) on 2019-08-14 22:20:42
//--------------------------------------------------------------------------------
...
wire sdram_accum_req_i;
reg sdram_accum_req_o = 1'd0;
reg sdram_accum_count = 1'd0;
...
assign sdram_accum_req_i = sdram_timer_done0;
...
always @(*) begin
	...
	litedramcore_slave_sel[2] <= (litedramcore_shared_adr[28:22] == 2'd2);
	litedramcore_slave_sel[3] <= (litedramcore_shared_adr[28:25] == 4'd8);
// synthesis translate_off
	dummy_d_275 = dummy_s;
// synthesis translate_on
end
...
always @(posedge sys_clk) begin
	...
	if (sdram_timer_wait) begin
		if ((~sdram_timer_done0)) begin
			if ((sdram_timer_load & (sdram_timer_load_count < sdram_timer_count1))) begin
				sdram_timer_count1 <= sdram_timer_load_count;
			end else begin
	...
	sdram_accum_req_o <= 1'd0;
	if (sdram_accum_req_i) begin
		sdram_accum_count <= (sdram_accum_count - 1'd1);
		if ((sdram_accum_count == 1'd0)) begin
			sdram_accum_count <= 1'd0;
			sdram_accum_req_o <= 1'd1;
		end
	end
